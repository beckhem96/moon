...
const pages = [["홈","/"],["카탈로그","/artifacts"],["상세","/artifacts/moon-jar"],["이미지상세","/artifacts/nmk-img-4328"],["타임라인","/timeline"],["소개","/about"],["임베드","/embed/moon-jar"],["전시관","/exhibition"],["스토리","/story"],["스토리챕터","/story/clay-to-fire"],["스토리불교","/story/buddha-faces"],["의미검색","/search"],["퀴즈","/quiz"]];
